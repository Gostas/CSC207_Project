...
public class HomeScreenController{
     ...
     */
    @FXML
    void addRoomPressed() throws IOException {
        Stage eventStage;
     ...
     */
    @FXML
    void createEventPressed() throws IOException {
     ...
     */
    @FXML
    void createUserAccountPressed() throws IOException {
     ...
     */
    @FXML
    void messageEventAttendeesPressed() {
     ...
     * @throws IOException to handle a possible exception in the input or the output.     */
    @FXML
    void removeEventPressed() throws IOException {
     ...
     */
    @FXML
    void scheduleSpeakerPressed() throws IOException {
     ...
     */
    @FXML
    void showSchedule() throws IOException {
        Stage scheduleStage;
