...
public class ScheduleTableController {
     ...
     */
    @FXML
    private TableColumn<Object, LocalDateTime> datetimeColumn;
    /**
    ...
    public void initialize() {
        ...
        eventTable.getSortOrder().addAll(datetimeColumn, titleColumn, locationColumn, typeColumn, durationColumn);

        setColumnValue();

        eventTable.getSelectionModel().setCellSelectionEnabled(true);

        datetimeColumn.setComparator(new DateTimeStringComparator());

        SortedList<main.java.Entities.Event> sortedList = eventTableView.getSortedEvents();
