...
public class EventTableView {
    ...
    public EventTableView(EventManager eventManager, String username) {
        ...
        this.sortedList = new SortedList<>(filteredListEvents);
    }
     ...
     */
    private ObservableList<Event> constructEventData() {
    ...
    public SortedList<Event> getSortedEvents(){return this.sortedList;}
     ...
     */
    public void setDatetimeColumn(TableColumn<Object, LocalDateTime> datetimeColumn) {
